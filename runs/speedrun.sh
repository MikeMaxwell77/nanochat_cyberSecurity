...
#/////////////////////////////////////////////////////////////////////
# removed because we did the entire dataset
...
# //////////removed//// torchrun --standalone --nproc_per_node=2 -m scripts.base_train -- --depth=24 --target-param-data-ratio=8 --device-batch-size=16 --fp8 --run=$WANDB_RUN
# evaluate the model: CORE metric, BPB on train/val, and draw samples
# //////////removed////torchrun --standalone --nproc_per_node=2 -m scripts.base_eval -- --device-batch-size=16
